...
function commands() {
  ...
  return {
    ...
    getCatalog: knex => knex.raw(`SELECT "datname" as "name" FROM "pg_catalog"."pg_database"`),
    ...
    getForeignKeyConstraints: (knex, schemaOwner, tableName) =>
    ...
    getPrimaryKeyConstraints: (knex, schemaOwner, tableName) =>
